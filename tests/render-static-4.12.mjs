...
{id:'cab1',catalogCode:'MAIN-CAB-42U',x:210,y:360,width:124,height:84,label:'CAB-1',properties:{networkLevel:'main',boxNo:'01',capacity:288,ports:144,odfCode:'ODF-144',odfPort:'P01',splitterCode:'SP-1X16',splitterPort:'S01',coreRange:'1-144',villaNo:'HQ'}},
...
await writeFile(new URL('../docs/samples/cad-final-4.12-preview.html',import.meta.url),html);
...
await writeFile(new URL('../docs/samples/cad-final-4.12-demo.svg',import.meta.url),sampleSvg);
await writeFile(new URL('../docs/samples/cad-final-4.12-demo.dxf',import.meta.url),exportEngineeringDxf(module.state.snapshot,{drawingNo:'P001-CAD-TEST',title:'Secondary Fiber Network',project:'First Fiber Optical',site:'Test Site',revision:'R1'},{...module.state.settings,catalog:module.state.catalog}));
console.log('rendered phase 4.12');process.exit(0);
