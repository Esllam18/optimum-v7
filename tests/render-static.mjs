...
await writeFile(new URL('../docs/samples/cad-visual-master-4.10-preview.html',import.meta.url),html);
...
await writeFile(new URL('../docs/samples/cad-visual-master-4.10-demo.svg',import.meta.url),sampleSvg);
await writeFile(new URL('../docs/samples/cad-visual-master-4.10-demo.dxf',import.meta.url),exportEngineeringDxf(module.state.snapshot,{drawingNo:'P001-CAD-TEST',title:'Secondary Fiber Network',project:'First Fiber Optical',site:'Test Site',revision:'R1'},{...module.state.settings,catalog:module.state.catalog}));
